...
struct ring_buf {
	...
	size_t		array_head;		/**< Голова буфера. Индекс позиции начала заполнения буфера. */
	size_t		array_tail;		/**< Хвост буфера. Индекс позиции следующей за последним занятым элементом. */
